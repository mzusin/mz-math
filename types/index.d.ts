declare const api: {
    ...
    dxCot: (x: number, decimalPlaces?: number) => number;
    dxArcSin: (x: number, decimalPlaces?: number) => number;
    dxArcCos: (x: number, decimalPlaces?: number) => number;
    dxArcTan: (x: number, decimalPlaces?: number) => number;
    dxArcCot: (x: number, decimalPlaces?: number) => number;
    ...
    v2QuadraticBezierCurve: (t: number, startControlPoint: import("./types").Vector2, centerControlPoint: import("./types").Vector2, endControlPoint: import("./types").Vector2, decimalPlaces?: number) => import("./types").Vector2;
    ...
    v2QuadraticBezierCurveNormal: (t: number, startControlPoint: import("./types").Vector2, centerControlPoint: import("./types").Vector2, endControlPoint: import("./types").Vector2, decimalPlaces?: number) => import("./types").Vector2;
    ...
    v2QuadraticBezierCurveExtrema: (startControlPoint: import("./types").Vector2, centerControlPoint: import("./types").Vector2, endControlPoint: import("./types").Vector2, decimalPlaces?: number) => import("./types").Vector;
