declare const api: {
    ...
    m3RotationXH: (angleRad: number, isClockwise?: boolean, decimalPlaces?: number) => import("./types").Matrix;
    ...
    m3RotationYH: (angleRad: number, isClockwise?: boolean, decimalPlaces?: number) => import("./types").Matrix;
    ...
    m3RotationZH: (angleRad: number, isClockwise?: boolean, decimalPlaces?: number) => import("./types").Matrix;
    ...
    m3ScaleH: (scaleVector: import("./types").Vector) => import("./types").Matrix;
    ...
    m3ScaleXH: (scale: number) => import("./types").Matrix;
    ...
    m3ScaleZH: (scale: number) => import("./types").Matrix;
    ...
    m3ReflectionOriginH: () => import("./types").Matrix;
    ...
    m3ReflectionYZH: () => import("./types").Matrix;
    m3ReflectionXZ: () => import("./types").Matrix3;
    m3ReflectionXZH: () => import("./types").Matrix;
    m3ReflectionXY: () => import("./types").Matrix3;
    m3ReflectionXYH: () => import("./types").Matrix;
