# Bezier Curve Tangent Vector

**Cubic Bézier curve tangent for 2D Vector**

```js
import { v2CubicBezierCurveTangent, Vector2 } from 'mz-math';
...
const result: Vector2 = v2CubicBezierCurveTangent(
    t, 
    startControlPoint,
    center1ControlPoint,
    center2ControlPoint,
...
**Cubic Bézier curve tangent for 3D Vector**

```js
import { v3CubicBezierCurveTangent, Vector2 } from 'mz-math';
...
const result: Vector3 = v3CubicBezierCurveTangent(
    t, 
    startControlPoint,
    center1ControlPoint,
    center2ControlPoint,
...
**Quadratic Bézier curve tangent for 3D Vector**
