...
const result: Vector2|null = linearEquationSystem2(equation1, equation2); // [1, 2] i.e. x=1, y=2
```
...
const result: Vector3|null = linearEquationSystem3(equation1, equation2, equation3); // [1, -2, -1] i.e. x=1, y=-2, z=-1
```
